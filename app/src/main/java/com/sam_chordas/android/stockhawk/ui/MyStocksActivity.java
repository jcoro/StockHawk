...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, CustomResultReceiver.Receiver{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected){
            new MaterialDialog.Builder(mContext)
                    ...
                    .positiveText(R.string.no_connection_dialog_agree)
                    .show();
        }
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View v, int position) {
                        ...
                        Intent detailIntent = new Intent(mContext, com.sam_chordas.android.stockhawk.ui.DetailActivity.class);
                        mCursor.moveToPosition(position);
                        detailIntent.putExtra("symbol", mCursor.getString(mCursor.getColumnIndex("symbol")));
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this, getResources().getString(R.string.already_saved),
                                                        Toast.LENGTH_LONG);
